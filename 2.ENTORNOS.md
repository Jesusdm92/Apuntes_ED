...
- Codigo binario
- Bibliotecas (librerías): Una serie de archivo en código fuente, o código objeto, que amplia la funcionalidad del lenguaje. 
- Compilar: Traducir el código fuente a código objeto.
- Enlazar (Link): Coger varios archivos objetos y juntarlos para crear un ejecutable.
- Interpretar: Partimos del código fuente, se convierte en binario y lo ejecutamos.
...
- Tipos
  ...
  - bibliotecas estática (.LIB o .a)
    ...
    ventajas:
      - Funciona en culquier sitio
    Desventaja:
      -Aumenta el tamñpo del archivo bastante
      -Mayor espacio en disco
      -Si se modifica la biblioteca hay qu erecompilar todos los programas.
