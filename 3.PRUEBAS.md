...
- Pruebas unitarias (o de unidad) (se comprueba que no se tienen fallos al ejecutar el código)
- Pruebas de regresión ( se comprueba a la hora de actualizar el código que las pruebas que antes se pasaban, se siguen pasando)
- Pruebas de integración 
- Pruebas del sistema (se comprueba que no hay problemas con el sistema operativo)
- Pruebas de humo (smooke test) 
- Pruebas alfa y beta (alfa: son pruebas que se afectuan en un entorno controlado en la empresa. Beta:Entorno no controlado)
